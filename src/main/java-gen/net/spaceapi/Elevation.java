...
public class Elevation {
     ...
     */
    @JsonProperty("unit")
    public void setUnit(Elevation.Unit unit) {
        this.unit = unit;
    }
    ...
    public static enum Unit {
        ...
        private static Map<String, Elevation.Unit> constants = new HashMap<String, Elevation.Unit>();

        static {
            for (Elevation.Unit c: values()) {
        ...
        @JsonCreator
        public static Elevation.Unit fromValue(String value) {
            Elevation.Unit constant = constants.get(value);
            if (constant == null) {
