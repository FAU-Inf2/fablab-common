...
public class Beta_gamma {
     ...
     */
    @JsonProperty("unit")
    public Beta_gamma.Unit getUnit() {
        return unit;
    }
     ...
     */
    @JsonProperty("unit")
    public void setUnit(Beta_gamma.Unit unit) {
        this.unit = unit;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Beta_gamma) == false) {
            return false;
        }
        Beta_gamma rhs = ((Beta_gamma) other);
    ...
    public static enum Unit {
        ...
        private static Map<String, Beta_gamma.Unit> constants = new HashMap<String, Beta_gamma.Unit>();

        static {
            for (Beta_gamma.Unit c: values()) {
        ...
        @JsonCreator
        public static Beta_gamma.Unit fromValue(String value) {
            Beta_gamma.Unit constant = constants.get(value);
            if (constant == null) {
