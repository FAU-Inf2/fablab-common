...
public class Betum {
     ...
     */
    @JsonProperty("unit")
    public void setUnit(Betum.Unit unit) {
        this.unit = unit;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Betum) == false) {
            return false;
        }
        Betum rhs = ((Betum) other);
    ...
    public static enum Unit {
        ...
        private static Map<String, Betum.Unit> constants = new HashMap<String, Betum.Unit>();

        static {
            for (Betum.Unit c: values()) {
        ...
        @JsonCreator
        public static Betum.Unit fromValue(String value) {
            Betum.Unit constant = constants.get(value);
            if (constant == null) {
