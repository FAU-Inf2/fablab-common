...
public class Gamma {
     ...
     */
    @JsonProperty("unit")
    public void setUnit(Gamma.Unit unit) {
        this.unit = unit;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gamma) == false) {
            return false;
        }
        Gamma rhs = ((Gamma) other);
    ...
    public static enum Unit {
        ...
        private static Map<String, Gamma.Unit> constants = new HashMap<String, Gamma.Unit>();

        static {
            for (Gamma.Unit c: values()) {
        ...
        @JsonCreator
        public static Gamma.Unit fromValue(String value) {
            Gamma.Unit constant = constants.get(value);
            if (constant == null) {
