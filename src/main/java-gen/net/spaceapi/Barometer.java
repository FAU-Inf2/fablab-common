...
public class Barometer {
     ...
     */
    @JsonProperty("unit")
    public void setUnit(Barometer.Unit unit) {
        this.unit = unit;
    }
    ...
    public static enum Unit {
        ...
        private static Map<String, Barometer.Unit> constants = new HashMap<String, Barometer.Unit>();

        static {
            for (Barometer.Unit c: values()) {
        ...
        @JsonCreator
        public static Barometer.Unit fromValue(String value) {
            Barometer.Unit constant = constants.get(value);
            if (constant == null) {
