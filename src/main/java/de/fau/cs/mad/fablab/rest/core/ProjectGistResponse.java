...
public class ProjectGistResponse implements Serializable {
    ...
    public ProjectGistResponse() {
    }

    public ProjectGistResponse(String url, String forks_url, String commits_url, String id, String git_pull_url, String git_push_url, String html_url, String files, boolean isPublic, String created_at, String updated_at, String description, String comments, String user, String comments_url, String owner, String forks, String history) {
        this.url = url;
